# Rust 2.0 M6：DataChannel 单文件传输结果
...
- [发送者桌面端](../../rust-v2/screenshots/m6-transfer-owner-desktop-chromium.png)
- [接收者桌面端](../../rust-v2/screenshots/m6-transfer-receiver-desktop-chromium.png)
- [发送者移动端](../../rust-v2/screenshots/m6-transfer-owner-mobile-chromium.png)
- [接收者移动端](../../rust-v2/screenshots/m6-transfer-receiver-mobile-chromium.png)
