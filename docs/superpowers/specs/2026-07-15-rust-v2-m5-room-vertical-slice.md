# Rust 2.0 M5：Dioxus 房间垂直切片结果

> 结论：**M5 通过，可以进入 M6 DataChannel 单接收者文件垂直切片。**

## 1. 本阶段交付结果

M5 第一次把 Rust 2.0 的 Dioxus 页面、Axum 控制面和实时房间协议连成完整用户链路。两个独立浏览器现在可以完成：
...
`v2/apps/web/src/main.rs` 使用一个显式 `AppModel` 管理四种顶层页面状态：
...
- [发送者桌面端](../../rust-v2/screenshots/m5-room-owner-desktop-chromium.png)
- [发送者移动端](../../rust-v2/screenshots/m5-room-owner-mobile-chromium.png)
- [接收者桌面端](../../rust-v2/screenshots/m5-room-receiver-desktop-chromium.png)
- [接收者移动端](../../rust-v2/screenshots/m5-room-receiver-mobile-chromium.png)
